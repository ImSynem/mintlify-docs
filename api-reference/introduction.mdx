---
title: 'CashPay API'
description: 'Accept and process Cash App payments through the CashPay API'
---

## Step 1: Authentication

To use the Hoodpay API, you will need to authenticate using an API key. You can obtain an API key by registering for an account on our website. Once you have an API key, you will need to include it in every request to our API by including it in the `Authorization` header like so: `Authorization: Bearer your_api_key_here`

## Step 2: Endpoints

The Hoodpay API provides several endpoints that you can use to interact with our service. You can find detailed information about each endpoint in our API Specs.

Here are a few of the most commonly used endpoints:

- [Payments](https://docs.cashpay.space/api-reference/payments) View/Create the payments.
- [Businesses](https://docs.cashpay.space/api-reference/businesses) Get your businesses.
- [Public Payments](https://docs.cashpay.space/api-reference/public-payments) View/Take actions as customer for payments.
